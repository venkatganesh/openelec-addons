...
__scriptname__ = "mysql service"
__author__ = "OpenELEC"
__url__ = "http://www.openelec.tv"
__settings__ = xbmcaddon.Addon(id='service.databases.mysql')
__cwd__ = __settings__.getAddonInfo('path')
__start__ = xbmc.translatePath( os.path.join( __cwd__, 'bin', "mysql-server.start") )
__stop__ = xbmc.translatePath( os.path.join( __cwd__, 'bin', "mysql-server.stop") )
